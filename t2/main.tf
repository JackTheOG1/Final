...
resource "azurerm_container_group" "teacher-aci" {
  name = "aci-jackpederson-acmp"
  location = "Central US"
  resource_group_name = "rg-jackpederson"
  ip_address_type = "Public"
  dns_name_label = "acmp-jackpederson-instance"
  os_type = "Linux"

  container {
    name   = "final"
    image  = "jackpedersonacmp2400.azurecr.io/final:latest"
    cpu    = "0.5"
    memory = "1.5"
  ...
  image_registry_credential {
    server   = "jackpedersonacmp2400.azurecr.io"
